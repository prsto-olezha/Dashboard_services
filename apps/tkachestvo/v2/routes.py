...
tkachestvo_router_v2 = APIRouter(
    prefix="/v2", tags=['Tkachestvo']
)


@tkachestvo_router_v2.get('/get-stats', response_model=TkachestvoGetStatsResponse)
...
@tkachestvo_router_v2.post('/upload-data')
